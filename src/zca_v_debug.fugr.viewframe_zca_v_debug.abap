*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCA_V_DEBUG
*   generation date: 01.05.2021 at 23:42:50
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCA_V_DEBUG         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCA_V_DEBUG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCA_V_DEBUG_EXTRACT
TOTAL = ZCA_V_DEBUG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCA_V_DEBUG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCA_V_DEBUG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCA_V_DEBUG_EXTRACT
TOTAL = ZCA_V_DEBUG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCA_V_DEBUG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCA_V_DEBUG'
...
TOTAL = ZCA_V_DEBUG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCA_V_DEBUG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCA_V_DEBUG-UPD_FLAG NE SPACE.
